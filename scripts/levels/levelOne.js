var levelOne = {
  ...
  elevators: [new Elevator(695, 260, 5, 220),
              new Elevator(195, 280, 5, 50),
              new Elevator(95, 90, 5, 250),
              new Elevator(435, 180, 5, 90),
              new Elevator(485, 120, 5, 90),
              new Elevator(545, 60, 5, 90)],
  ...
  enemies: [new BasicEnemy(390, 474, 12, 6, new Platform(360, 480, 340, 20)),
            new BasicEnemy(175, 174, 12, 6, new Platform(145, 180, 200, 10)),
            new BasicEnemy(425, 54, 12, 6, new Platform(395, 60, 110, 10)),
