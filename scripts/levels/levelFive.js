var levelFive = {
  ...
  iPlatforms: [new InvisiblePlatform(120, 460, 20, 10),
               new InvisiblePlatform(180, 290, 20, 10)],
  bPlatforms: [new BouncePlatform(350, 440, 250, 10)],
  elevators: [new Elevator(140, 300, 5, 110)],
